...
public class TopicModelTest {
    ...
    public static void main(String[] args)  throws Exception {
        ...
        pipeList.add( new TokenSequenceRemoveStopwords(new File("H:\\nlp jar files\\mallet-2.0.7\\mallet-2.0.7\\stoplists\\en.txt"), "UTF-8", false, false, false) );
        ...
        InstanceList testing = new InstanceList(traininginstances.getPipe());
        ...
        System.out.println("testProbabilities: "+ logLikelihood);
